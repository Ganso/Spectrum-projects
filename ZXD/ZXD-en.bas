...
1152 IF dificultad=0 THEN PRINT AT 18,0;"  Slow        Fast     Very slow"
1153 IF dificultad=1 THEN PRINT AT 18,0;"  ";PAPER 4;INK 0;FLASH 1;"Fast";PAPER 0;INK 7;FLASH 0;"        Fast       ";PAPER 4;INK 0;FLASH 1;"Fast";PAPER 0;INK 7;FLASH 0;"  "
...
8810 NEXT i
8815 PRINT AT 8, 11; PAPER 0; INK 4; BRIGHT 1; "SECRET  MENU"
8820 PRINT AT 10, 9; "SELECT LEVEL: ";FLASH (j=0);nivel
8825 PRINT AT 12, 8; "DIFFICULTY: ";INK 2;
8826 IF dificultad=0 THEN PRINT FLASH (j=1);" EASY "
8827 IF dificultad=1 THEN PRINT FLASH (j=1);" HARD "
8828 LET k$=INKEY$
